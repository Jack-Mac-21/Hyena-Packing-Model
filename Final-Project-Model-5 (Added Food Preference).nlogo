...
to reproduce-regular  ;; all animals have the same reproduction
  if energy > 150 [
...
"" ""
PENS
"_1_1_1" 1.0 0 -2674135 true "" "plot lion-energy"
"_1_1_1" 1.0 0 -8431303 true "" "plot hyena-energy"
...
471
874
Equilibrium for a while
set movement-cost 5\nset grass-regrowth-rate 0.3\nset grass-units-eaten-per-eat 7\nset lion-energy-gain-from-eating 90\nset hyena-energy-gain-from-eating 100\nset energy-gain-from-grass 14\nset lion-reproduction-cost 80\nset lion-reproduction-threshold 100\nset preference-threshold 29\nset lion-reproduction-threshold 179\nset lion-movement-cost 10
NIL
1
T
OBSERVER
...
@#$#@#$#@
## Why is Equilibrium so hard in this model??

When the reproduction rate is gauranteed to occur at a certain point, then as the population is doing well, they will grow rapidly causing resources to be depleted. Therefore, when resources become depleted there is a sharp fall off as no reproduction occurs, creating a high chance for extinction.

## Going forward...

I want to make a seperate model that instead uses reproduction that scales with energy. Meaning even lower energy animal have a chance to reproduce. 
@#$#@#$#@
default
true
0
